...
describe("function command handler", () => {
  ...
  it('command subAlias logs expected values', done => {
    const command = 'mainAlias subAlias -a true -n 100 -c cValue fooValue bazValue barValue1 barValue2';
    const expected = [
      '--- sub alias started ---',
      'a: true',
      'n: 100',
  ...
  it('command anotherSubAlias logs expected values', done => {
    const command = 'mainAlias anotherSubAlias -a true -n 100 -d dValue fooValue quxValue barValue1 barValue2';
    const expected = [
